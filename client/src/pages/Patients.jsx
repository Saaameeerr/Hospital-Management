...
const Patients = () => {
  ...
  const fetchPatients = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/api/patients?page=${currentPage}&search=${searchTerm}&limit=10`);
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      <div className="flex items-center space-x-2">
                        ...
                        <span>{new Date(patient.admittedDate).toLocaleDateString()}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      ...
                      {modalType === 'view' && selectedPatient && (
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900">{selectedPatient.age} years, {selectedPatient.gender}</p>
                          </div>
                          <div>
